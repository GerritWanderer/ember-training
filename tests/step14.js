/*
  In Step 14, you will add a song queue to BümBöx.
...
test("clicking the queue button adds the song to the queue", function() {
  ...
  var nowPlayingController = App.__container__.lookup('controller:nowPlaying');
...
test("clicking the play button inside queue should work", function() {
  ...
  equal($('footer:contains(A Walk)').length, 1, "The queued song is playing");
